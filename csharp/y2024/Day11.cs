...
[RunnableDay(year: 2024, day: 11)]
class Day11 : Day
{
    public override string PartOne()
    {
        return Blink(ReadInput(), 25).Values.Sum().ToString();
    }

    public override string PartTwo()
    {
        return Blink(ReadInput(), 75).Values.Sum().ToString();
    }

    private static Dictionary<long, long> BuildStonesMap(string input)
    {
