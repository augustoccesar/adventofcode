...
public class Point2D {
    ...
    /**
     * Create a new {@link Point2D} with moved {@code x} and {@code y} by {@code x} and {@code y} amount.
     * <p>
     * Example:
     * <pre>{@code
    ...
    /**
     * Calculate the Taxicab geometry (Manhattan distance) from this {@link Point2D} to
     * another one.
     *
