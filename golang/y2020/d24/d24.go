...
func (d *Day24) Year() int { return 2020 }
func (d *Day24) Day() int  { return 24 }

func (d *Day24) PartOne() string {
	blackTiles := parseInput(structure.ReadDefaultInput(d))

	return strconv.Itoa(len(blackTiles))
}

func (d *Day24) PartTwo() string {
	blackTiles := parseInput(structure.ReadDefaultInput(d))
