...
func (d *Day23) Year() int { return 2020 }
func (d *Day23) Day() int  { return 23 }

func (d *Day23) PartOne() string {
	inputItems := strings.Split(structure.ReadDefaultInput(d), "")
