...
func (d *Day20) Year() int { return 2020 }
func (d *Day20) Day() int  { return 20 }

func (d *Day20) PartOne() string {
	tiles := puzzleTogether(parseInput(structure.ReadDefaultInput(d)))
