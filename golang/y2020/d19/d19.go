...
func (d *Day19) Year() int { return 2020 }
func (d *Day19) Day() int  { return 19 }

func (d *Day19) PartOne() string {
	rules, messages := parseInput(structure.ReadDefaultInput(d))
