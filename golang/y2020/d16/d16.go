...
func (d *Day16) Year() int { return 2020 }
func (d *Day16) Day() int  { return 16 }

func (d *Day16) PartOne() string {
	rules, _, nearbyTickets := parseInput(structure.ReadDefaultInput(d))
...
func (d *Day16) PartTwo() string {
	rules, myTicket, nearbyTickets := parseInput(structure.ReadDefaultInput(d))
