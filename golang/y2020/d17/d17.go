...
func (d *Day17) Year() int { return 2020 }
func (d *Day17) Day() int  { return 17 }

func (d *Day17) PartOne() string {
	activeCubes, length, height := parseInput(structure.ReadDefaultInput(d))
