...
import com.augustoccesar.aocjava.y2019.shared.intcomputer.exceptions.InvalidOpCode;
...
public enum OpCode {
  ...
  @Getter private final int intCode;

  @Getter private final int paramSize;

  @Getter private final int pointerJump;

  @Getter() private final boolean writer;
